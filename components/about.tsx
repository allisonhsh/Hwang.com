...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"graduation","title":"단국대학교 도시계획부동산학","period":"2023~","description":"부동산학과 전공 / 경영학과 복수전공"},{"icon":"book","title":"TOEIC","period":"2023","description":"자격증"},{"icon":"target","title":"공인중개사 자격 준비","period":2026,"description":"자격증"},{"icon":"book","title":"어학연수 예정","period":"2026","description":"어학능력 향상"}],
    skills: [{"icon":"barChart","title":"데이터 기반 분석 및 해석","description":"실거래 및 입지 데이터를 해석하여 도시와 시장의 흐름을 파악"},{"icon":"pieChart","title":"데이터 시각화","description":"엑셀 기반의 통계자료 정리 및 그래프 시각화를 통한 정보의 명확한 전달"},{"icon":"shield","title":"신뢰 기반 협업","description":"명확한 소통과 일정 준수로 팀원들이 믿고 의지할 수 있는 협업 환경 구성"},{"icon":"trophy","title":"프로젝트 리드 & 조율","description":"팀의 방향을 설정하고 다양한 관점을 통합해 안정적으로 프로젝트를 완성"},{"icon":"brain","title":"구조적 문제 해결","description":"복잡한 정보를 체계적으로 정리해 핵심 원인을 찾아내고 해결 전략을 도출"},{"icon":"edit","title":"논리적 보고서 작성","description":"분석 결과를 일관된 논리로 구성해 더 명확하고 설득력 있게 전달"}],
    storyTitle: "나의 이야기",
